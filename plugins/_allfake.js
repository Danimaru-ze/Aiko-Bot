    ...
    global.adCh = {
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: chat.channel,
          serverMessageId: null,
          newsletterName: `📡ping : ${ms}  ||  ⌜ ${global.bot.watermark} ⌟ © ${owner.name || owner.name}`,
        },
    ...
    global.adReply = {
      contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
          newsletterJid: chat.channel,
          serverMessageId: null,
          newsletterName: `📡ping : ${ms}  ||  ⌜ ${bot.name} ⌟ © ${infoo.ownername || global.info.namaowner}`,
        },
        externalAdReply: {
          title: ucapan(),
          body: bot.project || bot.name,
    ...
    global.fkontak = {
      ...
      message: {
        contactMessage: {
          ...
          jpegThumbnail: fs.readFileSync("./assets/media/thumbnail.jpg"),
          thumbnail: fs.readFileSync("./assets/media/thumbnail.jpg"),
          sendEphemeral: true,
        },
      },
    };
