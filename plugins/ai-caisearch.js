          ...
          return {
            ...
            nativeFlowMessage: {
              buttons: [
                {
                  name: "cta_url",
                  buttonParamsJson: `{"display_text":"Pilih ${char.participant__name} (${index + 1})","url":"https://wa.me/${global.pairing.number}?text=.caiset ${index + 1}","merchant_url":"https://wa.me/${global.pairing.number}?text=.caiset ${index + 1}"}`,
                },
              ],
            },
          };
