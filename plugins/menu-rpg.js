  ...
  try {
    ...
    let fkon = {
      key: {
        ...
        ...(m.chat ? { remoteJid: owner.number+"@s.whatsapp.net" } : {}),
      },
      message: {
        contactMessage: {
          displayName: `${name}`,
    ...
    if (globall.menugif.menurpg) {
        ...
        true,
        {
          ...
          contextInfo: {
            externalAdReply: {
              title: ucapan() + " " + name,
              body: bot.watermark,
              thumbnailUrl: bot.RandomThumbnailUrl() || bot.thumbnailPath,
              sourceUrl: globall.link.saluran,
              mediaType: 1,
      ...
      await conn.sendMessage(
        m.chat,
        {
          ...
          contextInfo: {
            externalAdReply: {
              title: bot.project || bot.watermark,
              body: m.pushName,
              thumbnailUrl: bot.RandomThumbnailUrl() || bot.thumbnailPath,
              sourceUrl: global.link.group,
              mediaType: 1,
              renderLargerThumbnail: true,
            },
          },
